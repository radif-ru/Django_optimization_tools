...
urlpatterns = [
    ...
    # path('categories_read/', adminapp.categories_read, name='categories_read'),
    path('categories_read/', adminapp.ProductCategoriesRead.as_view(), name='categories_read'),
    path('category/create/', adminapp.ProductCategoryCreate.as_view(), name='category_create'),
    path('category/<int:category_pk>/update/', adminapp.ProductCategoryUpdate.as_view(),
         name='category_update'),
    path('category/<int:pk>/delete/', adminapp.ProductCategoryDelete.as_view(),
         name='category_delete'),

    path('category/<int:category_pk>/products/', adminapp.category_products,
         name='category_products'),
    path('category/<int:category_pk>/product/create/', adminapp.product_create,
         name='product_create'),
    path('product/<int:product_pk>/detail/', adminapp.ProductDetail.as_view(), name='product_read'),
